...
public class WebDriverFactory {
    ...
    public static WebDriver createNewWebDriver(String browser, String os) {
        ...
        if ("FIREFOX".equalsIgnoreCase(browser)) {
            ...
            String profilePath = "C:\\Users\\vova\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\dexkru7m.default-release";
        ...
        /******** The driver selected is Chrome  ********/
            ...
            options.setBinary("C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe"); // For Windows
            options.addArguments("--user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.5563.147 Safari/537.36");
